...
### Chart A Plot of Aisles Ordered More Than 10000 Items
...
### Chart B Boxplot of number of aisle selection among departments 
```{r}
b = instacart %>%
...
### Chart C Boxplot of number of aisle selection among departments
